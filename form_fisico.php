...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `fisico`(`tipoPessoa`, `id_cliente`, `nome`, `sobrenome`, `cpf`, `rg`, `logradouro`, `cep`, `num`, `complemento`, `id_bairro`, `cidade`, `cel`, `email`) 
            VALUES (:tipoPessoa,  :id_cliente, :nome, :sobrenome, :cpf, :rg, :logradouro, :cep, :num, :complemento, :id_bairro, :cidade, :cel, :email)";
